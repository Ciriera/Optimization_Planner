...
from app.algorithms.simplex import SimplexAlgorithm
from app.algorithms.cpSat_tabu_nsga import HybridCPSATTabuSANsga
from app.algorithms.lexicographic import HybridLexicographicAdvanced
...
class AlgorithmFactory:
    ...
    def create_algorithm(
        ...
        if algorithm == "simplex":
            return SimplexAlgorithm(
                ...
                max_iterations=algorithm_params["max_iterations"],
                tolerance=algorithm_params["tolerance"]
            )
        ...
        elif algorithm == "hybrid_cpsat_tabu_nsga":
            return HybridCPSATTabuSANsga(
                projects=projects,
                instructors=instructors,
                parameters=algorithm_params
            )
        elif algorithm == "lexicographic_advanced":
            return HybridLexicographicAdvanced(
                projects=projects,
                instructors=instructors,
                parameters=algorithm_params
            )
    ...
    def get_algorithm(algorithm_name: str) -> Optional[BaseAlgorithm]:
        ...
        algorithms = {
            ...
            "hybrid_cpsat_tabu_nsga": HybridCPSATTabuSANsga(),
            "lexicographic_advanced": HybridLexicographicAdvanced()
        }
