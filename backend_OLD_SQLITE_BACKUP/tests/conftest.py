...
# Test veritabanı URL'si - PostgreSQL
SQLALCHEMY_DATABASE_URL = "postgresql+asyncpg://postgres:password@localhost:5432/ceng_project_test"

# Test veritabanı motoru (PostgreSQL)
