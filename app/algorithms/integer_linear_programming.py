"""
Integer Linear Programming Algorithm - Enhanced with Pure Consecutive Grouping
...
class IntegerLinearProgramming(OptimizationAlgorithm):
    """
    Integer Linear Programming Algorithm - Enhanced with Pure Consecutive Grouping + Smart Jury Assignment.
    ...
    def optimize(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Run Integer Linear Programming optimization with Pure Consecutive Grouping + Smart Jury.
        ...
        logger.info("Integer Linear Programming Algorithm başlatılıyor (Enhanced Randomizer + Consecutive Grouping + Smart Jury mode)...")
        ...
        logger.info(f"Integer Linear Programming Algorithm completed. Execution time: {execution_time:.2f}s")
        ...
        return {
            ...
            "algorithm": "Integer Linear Programming (Enhanced Randomizer + Consecutive Grouping + Smart Jury)",
            "status": "completed",
            "optimizations_applied": [
                ...
                "integer_linear_programming_optimization"
            ],
            "stats": final_stats,
            "parameters": {
    ...
    def repair_solution(self, solution: Dict[str, Any], validation_report: Dict[str, Any]) -> Dict[str, Any]:
        """
        Integer Linear Programming için özel onarım metodları.
        """
        assignments = solution.get("assignments", [])
        
        # ILP-specific repair
        assignments = self._repair_duplicates_ilp(assignments)
        assignments = self._repair_gaps_ilp(assignments)
        assignments = self._repair_coverage_ilp(assignments)
        
        solution["assignments"] = assignments
        return solution

    def _repair_duplicates_ilp(self, assignments):
        """ILP-specific duplicate repair"""
        from collections import defaultdict
    ...
    def _repair_gaps_ilp(self, assignments):
        """ILP-specific gap repair"""
        # Keep all assignments - no gap filling needed for consecutive grouping
        return assignments

    def _repair_coverage_ilp(self, assignments):
        """ILP-specific coverage repair ensuring all projects are assigned"""
