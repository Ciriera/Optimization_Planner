"""
Greedy (Açgözlü) algoritması sınıfı.
"""
...
class Greedy(OptimizationAlgorithm):
    """
    Greedy (Açgözlü) algoritması sınıfı.
    Açgözlü yaklaşım kullanarak proje atama problemini çözer.
    """
    
    def __init__(self, params: Dict[str, Any] = None):
        """
        Greedy algoritması başlatıcı.
        ...
        params = params or {}
        self.local_search_iterations = params.get("local_search_iterations", 100)
        self.best_solution = None
        self.best_fitness = float('-inf')
    
    def initialize(self, data: Dict[str, Any]) -> None:
        """
        Greedy algoritmasını başlangıç verileri ile başlatır.
    ...
    def _greedy_solution(self) -> List[Dict[str, Any]]:
        """
        Açgözlü yaklaşımla bir çözüm oluşturur.
        
        Returns:
            List[Dict[str, Any]]: Açgözlü çözüm.
        """
        solution = []
    ...
    def _local_search(self, solution: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
        Yerel arama ile çözümü iyileştirir.
