"""
Greedy Algorithm - Enhanced with Pure Consecutive Grouping + Smart Jury Assignment
...
class Greedy(OptimizationAlgorithm):
    ...
    def __init__(self, params: Dict[str, Any] = None):
        """
        Initialize Greedy Algorithm with Pure Consecutive Grouping.
        ...
        # Greedy parameters
        self.greedy_factor = params.get("greedy_factor", 0.8)
        self.local_search_iterations = params.get("local_search_iterations", 50)
    ...
    def optimize(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Run Greedy Algorithm optimization with Pure Consecutive Grouping + Smart Jury.
        ...
        logger.info("Greedy Algorithm başlatılıyor (Enhanced Randomizer + Consecutive Grouping + Smart Jury mode)...")
        ...
        logger.info(f"Greedy Algorithm completed. Execution time: {execution_time:.2f}s")
        ...
        return {
            ...
            "algorithm": "Greedy Algorithm (Enhanced Randomizer + Consecutive Grouping + Smart Jury)",
            "status": "completed",
    ...
    def repair_solution(self, solution: Dict[str, Any], validation_report: Dict[str, Any]) -> Dict[str, Any]:
        """
        Greedy Algorithm için özel onarım metodları.
        """
        assignments = solution.get("assignments", [])
        
        # Greedy-specific repair
        assignments = self._repair_duplicates_greedy(assignments)
        assignments = self._repair_coverage_greedy(assignments)
        
        solution["assignments"] = assignments
        return solution

    def _repair_duplicates_greedy(self, assignments):
        """Greedy-specific duplicate repair"""
        from collections import defaultdict
    ...
    def _repair_coverage_greedy(self, assignments):
        """Greedy-specific coverage repair ensuring all projects are assigned"""
