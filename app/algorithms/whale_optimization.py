"""
Whale Optimization Algorithm - Enhanced with Pure Consecutive Grouping
...
class WhaleOptimization(OptimizationAlgorithm):
    """
    Whale Optimization Algorithm - Enhanced with Pure Consecutive Grouping + Smart Jury Assignment.
    ...
    def optimize(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Whale Optimization Algorithm with Pure Consecutive Grouping + Smart Jury.
        ...
        logger.info("Whale Optimization Algorithm başlatılıyor (Enhanced Randomizer + Consecutive Grouping + Smart Jury mode)...")
        ...
        logger.info(f"Whale Optimization Algorithm completed. Execution time: {execution_time:.2f}s")
        ...
        return {
            ...
            "algorithm": "Whale Optimization (Enhanced Randomizer + Consecutive Grouping + Smart Jury)",
            "status": "completed",
