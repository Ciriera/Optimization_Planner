...
class Instructor(Base):
    ...
    def __repr__(self):
        return f"<Instructor {self.name}, {self.role}>"
    ...
    def _convert_instructor_type(type_str: str) -> InstructorType:
        ...
        type_mapping = {
            "professor": InstructorType.HOCA,
            "research_assistant": InstructorType.ARAS_GOR,
            "instructor": InstructorType.HOCA,
            "assistant": InstructorType.ARAS_GOR,
        }
        ...
        try:
            ...
            # Default to HOCA if unknown
            return InstructorType.HOCA 