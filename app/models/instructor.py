...
class Instructor(Base):
    ...
    user_id = Column(Integer, ForeignKey("users.id"), nullable=True)  # Added user_id field
    
    # İlişkiler
    user = relationship("User", backref="instructor", uselist=False)  # Added user relationship
